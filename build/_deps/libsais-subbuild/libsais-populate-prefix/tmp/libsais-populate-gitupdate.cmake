...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.8.1"
  WORKING_DIRECTORY "/home/i3gupta/bestFitAl/build/_deps/libsais-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/i3gupta/bestFitAl/build/_deps/libsais-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/i3gupta/bestFitAl/build/_deps/libsais-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
